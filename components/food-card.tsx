    ...
    <Card className="overflow-hidden">
      ...
      <div className="p-3">
        ...
        <div className="flex justify-between items-center mb-2">
          <span className={`text-${restaurantInfo.primaryColor}-600 font-bold`}>${price.toFixed(2)}</span>
          <div className="flex items-center gap-1">
            <span className={`w-2 h-2 rounded-full ${foodType.color}`}></span>
            <span className="text-xs text-gray-500">{foodType.label}</span>
          </div>
        </div>
